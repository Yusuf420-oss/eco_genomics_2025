...
MYREPO="/users/y/o/yoyebami/Projects_Genomics/eco_genomics_2025/"
...
for READ1 in ${MYSAMP}*_1.fastq.gz
do
...
READ2=${READ1/_1.fq.gz/_2.fastq.gz}

# make the output file names: print the fastq name, replace _# with _#_clean

NAME1=$(echo $READ1 | sed "s/_R1/_T1_cleanOY/g")
NAME2=$(echo $READ2 | sed "s/_R2/_T2_cleanOY/g")
