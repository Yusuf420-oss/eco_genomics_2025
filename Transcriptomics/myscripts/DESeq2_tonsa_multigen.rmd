...
knitr::opts_knit$set(root.dir="/users/y/o/yoyebami/Projects_Genomics/eco_genomics_2025/Transcriptomics/mydata")
```
...
##Note Generally 20M reads are required
...
#GENETION 2
#Question: How does gene expression change across generations for the genes that are initially differentially expressed in Generation 2 (between different developmental temperatures, 18 vs. 22 C)

```{r}
sig_genes_G2 <- rownames(resG2_CvT[which(resG2_CvT$padj < 0.05 & !is.na(resG1_CvT$padj)), ])
