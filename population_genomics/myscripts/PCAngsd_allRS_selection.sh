...
#SBATCH --job-name=PCAngsd_allRS_selection.sh
...
#SBATCH --output=/users/y/o/yoyebami/Projects_Genomics/eco_genomics_2025/population_genomics/mylogs/%x_%j.out
...
#SBATCH --mail-user=Yusuf.Oyebamiji@uvm.edu
...
mkdir ~/Projects_Genomics/eco_genomics_2025/population_genomics/myresults/ANGSD/PCA_ADMIX

OUT="/users/y/o/yoyebami/Projects_Genomics/eco_genomics_2025/population_genomics/myresults/ANGSD/PCA_ADMIX"
