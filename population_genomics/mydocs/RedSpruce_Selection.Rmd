...
```
 ...
 Prepare the sample ID for plotting later 
```{r}
...
Make a PCA plot to see how strucutre may differ without the BS
...
```
 ...
 Test for Correlation between admixture scores frpm RSBS analysis
```{r}
